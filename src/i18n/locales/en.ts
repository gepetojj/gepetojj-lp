...
const en: Translations = {
	...
	pillars: {
		...
		items: [
			...
			},
			{
				...
				description:
					"Operational efficiency through intelligent automation, reducing manual effort and rework.",
			},
			{
				title: "Platforms & critical integrations",
				description:
					"Payments, APIs, and data connecting the systems that truly sustain operations.",
			},
			{
				title: "Reliability & scale",
				description:
					"Observability, performance, and cost control for systems that need to handle growth.",
			},
		],
	},
	stack: {
	...
	work: {
		...
		projects: [
			...
			},
			{
				...
				name: "SC Finance",
				description:
					"Executive financial intelligence platform with a unified view of pipeline, brokers, territories, and premium leads. Built for operations that demand clarity and refinement in every decision.",
				tags: [
					"FinTech",
					"B2B",
					"Dashboards",
	...
	contact: {
		...
		subtitle:
			"Open to conversations about technology, technical leadership, and partnerships.",
	},
	footer: {
		copyright: "© 2026 João Nobre · gepetojj. All rights reserved.",
